        ...
        {searchResults.length > 0 ? (
          <div className="grid grid-cols-1  sm:mx-0 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 mt-8">
            {searchResults.map((track) => (
              <div
                key={track.id}
                className="py-4 px-4 border rounded shadow-lg cursor-pointer"
            ...
            <div className="flex flex-col items-center justify-center sm:justify-start ml-4">
              ...
              <div className="flex items-center space-x-2">
                <button
                  ...
                  className="flex items-center justify-center w-16 h-10 sm:w-20 sm:h-8 text-white bg-indigo-500 rounded-md hover:bg-indigo-600 focus:outline-none px-2 py-1 sm:px-4 sm:py-2 transition duration-300 ease-in-out"
                >
                  <FontAwesomeIcon
